    ...
    return (
        <AvatarPrimitive.Root
            ...
            className={cn(
                ...
                'after:absolute after:inset-0 after:rounded-full after:border after:border-wire/80 after:mix-blend-darken dark:after:border-wire dark:after:mix-blend-lighten',
