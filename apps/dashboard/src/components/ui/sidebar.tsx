...
function SidebarRail({ className, ...props }: ComponentProps<'button'>) {
    ...
    return (
        <button
            ...
            className={cn(
                'absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear hover:after:bg-sidebar-border',
...
function SidebarGroupLabel({
    ...
    return (
        <Comp
            ...
            className={cn(
                'flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium tracking-wider text-muted-foreground uppercase ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear',
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                'group-data-[collapsible=icon]:hidden after:absolute after:-inset-2 focus-visible:ring-2 md:after:hidden',
...
const sidebarMenuButtonVariants = cva(
    [
        'peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-all duration-150',
...
function SidebarMenuAction({
    ...
    return (
        <Comp
            ...
            className={cn(
                'text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
                'absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-all duration-150',
                ...
                'after:absolute after:-inset-2 focus-visible:ring-2 md:after:hidden',
                '[&>svg]:size-4 [&>svg]:shrink-0',
                showOnHover &&
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                'flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 outline-hidden transition-all duration-150',
                'group-data-[collapsible=icon]:hidden focus-visible:ring-2',
